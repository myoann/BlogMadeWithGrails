	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="createPOI" controller="front" action="createPOI"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
			...
			<thead>
				...
				<g:each in="${groupeInstanceList}" status="i" var="groupeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link controller="front" action="showPOI" id="${groupeInstance.id}">${fieldValue(bean: groupeInstance, field: "nom")}</g:link></td>
