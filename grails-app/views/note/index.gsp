		...
		<div id="list-note" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="note.pointInteret.label" default="Point Interet" /></th>
					
						<th><g:message code="note.utilisateur.label" default="Utilisateur" /></th>
				...
				<g:each in="${noteInstanceList}" status="i" var="noteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: noteInstance, field: "pointInteret")}</td>
					
						<td>${fieldValue(bean: noteInstance, field: "utilisateur")}</td>
